...
const styles = StyleSheet.create({
  ...
  bannerEyebrow: { color: '#7A5310', fontSize: 12, fontWeight: '900', letterSpacing: 1.3 },
  countBadge: { minWidth: 24, borderRadius: 999, overflow: 'hidden', backgroundColor: '#7A5310', color: '#FFFFFF', paddingHorizontal: 7, paddingVertical: 4, textAlign: 'center', fontSize: 12, fontWeight: '900' },
  ...
  panelHeader: { gap: 7 },
  panelEyebrow: { color: '#7A5310', fontSize: 12, fontWeight: '900', letterSpacing: 1.3 },
  ...
  comparisonLabel: { color: appointmentColors.muted, fontSize: 12, fontWeight: '900', letterSpacing: 1 },
  comparisonName: { color: appointmentColors.text, fontSize: 14, lineHeight: 19, fontWeight: '800' },
  comparisonMeta: { color: appointmentColors.secondary, fontSize: 12 },
  ...
  financialTitle: { color: sharedBrand.colors.forest, fontSize: 12, fontWeight: '900' },
  financialText: { color: appointmentColors.secondary, fontSize: 12, lineHeight: 17 },
  ...
  waitingText: { color: appointmentColors.secondary, fontSize: 12, lineHeight: 17 },
  actionList: { gap: 10 },
  ...
  candidateMeta: { color: appointmentColors.secondary, fontSize: 12 },
  candidateLink: { color: sharedBrand.colors.forest, fontSize: 12, fontWeight: '900' },
  ...
  offlineText: { color: appointmentColors.secondary, fontSize: 12, lineHeight: 17 },
  ...
  retryButtonText: { color: sharedBrand.colors.forest, fontSize: 12, fontWeight: '900' },
  ...
  timelineMeta: { color: appointmentColors.secondary, fontSize: 12, lineHeight: 15 },
  protocol: { color: appointmentColors.muted, fontSize: 12, lineHeight: 12 },
