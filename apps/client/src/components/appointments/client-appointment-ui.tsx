...
const styles = StyleSheet.create({
  ...
  statusText: { fontSize: 12, lineHeight: 12, fontWeight: '900', letterSpacing: 0.5 },
  ...
  month: { color: appointmentColors.muted, fontSize: 12, fontWeight: '900', letterSpacing: 1.1 },
  ...
  dateLabel: { color: appointmentColors.muted, fontSize: 12, textTransform: 'capitalize' },
  rescheduleLabel: { alignSelf: 'flex-start', color: appointmentColors.confirmed, fontSize: 12, fontWeight: '800', backgroundColor: appointmentColors.confirmedSoft, borderRadius: 999, paddingHorizontal: 8, paddingVertical: 4 },
  ...
  detailLabel: { color: appointmentColors.muted, fontSize: 12, fontWeight: '900', letterSpacing: 1.15, textTransform: 'uppercase' },
