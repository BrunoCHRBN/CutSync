...
const styles = StyleSheet.create({
  ...
  statusNoticeText: { color: '#3C5544', fontSize: 12, lineHeight: 18 },
  ...
  successMark: { width: 76, height: 76, alignItems: 'center', justifyContent: 'center', borderRadius: 26, borderCurve: 'continuous', backgroundColor: sharedBrand.colors.forest, boxShadow: '0 16px 32px rgba(20, 27, 23, 0.14)' },
