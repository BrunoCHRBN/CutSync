...
const styles = StyleSheet.create({
  ...
  eyebrow: { color: sharedBrand.colors.forest, fontSize: 12, fontWeight: '900', letterSpacing: 1.5 },
  ...
  tabCount: { minWidth: 22, color: appointmentColors.muted, fontSize: 12, fontWeight: '900', textAlign: 'center', borderRadius: 999, backgroundColor: '#E0DBCC', paddingHorizontal: 6, paddingVertical: 4, fontVariant: ['tabular-nums'] },
