...
const styles = StyleSheet.create({
  ...
  metricLabel: { color: discoveryColors.secondary, fontSize: 12, textAlign: 'center', fontWeight: '600' },
  ...
  infoLabel: { color: discoveryColors.muted, fontSize: 12, fontWeight: '900', letterSpacing: 1.3 },
  ...
  serviceDuration: { color: discoveryColors.secondary, fontSize: 12 },
  serviceAction: { alignItems: 'flex-end', gap: 4 },
  servicePrice: { color: sharedBrand.colors.forest, fontSize: 14, fontWeight: '900' },
  serviceBookLabel: { color: discoveryColors.muted, fontSize: 12, fontWeight: '800', letterSpacing: 0.4 },
  divider: { height: 1, backgroundColor: discoveryColors.border },
  bookingHint: { color: discoveryColors.secondary, fontSize: 12, lineHeight: 16 },
