...
const styles = StyleSheet.create({
  ...
  heroEyebrow: { color: 'rgba(255, 255, 255, 0.7)', fontSize: 12, fontWeight: '900', letterSpacing: 1.4 },
  ...
  discoveryCtaEyebrow: { color: settingsColors.accent, fontSize: 12, fontWeight: '900', letterSpacing: 1.4 },
  ...
  securityNote: { color: settingsColors.muted, fontSize: 12, lineHeight: 17, textAlign: 'center', paddingHorizontal: 18 },
