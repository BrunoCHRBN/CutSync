...
const styles = StyleSheet.create({
  ...
  timeCard: { gap: 6, borderRadius: 28, borderCurve: 'continuous', backgroundColor: sharedBrand.colors.forest, padding: 24, boxShadow: '0 16px 32px rgba(20, 27, 23, 0.14)' },
  ...
  detailCard: { borderRadius: 26, borderCurve: 'continuous', backgroundColor: appointmentColors.card, paddingHorizontal: 20, paddingVertical: 6, boxShadow: '0 10px 26px rgba(20, 27, 23, 0.05)' },
