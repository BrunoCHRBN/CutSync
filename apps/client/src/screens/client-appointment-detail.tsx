...
const styles = StyleSheet.create({
  ...
  eyebrow: { color: sharedBrand.colors.forest, fontSize: 12, fontWeight: '900', letterSpacing: 1.5, paddingTop: 8 },
  ...
  duration: { color: 'rgba(255, 255, 255, 0.75)', fontSize: 12, fontWeight: '700', letterSpacing: 0.4 },
