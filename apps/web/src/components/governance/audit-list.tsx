...
const styles = StyleSheet.create({ list: { width: '100%', maxWidth: layout.contentMax, alignSelf: 'center', padding: 20, paddingBottom: 80, gap: 14 }, headerContent: { gap: 18, paddingBottom: 4 }, pageHeader: { flexDirection: 'row', alignItems: 'flex-end', justifyContent: 'space-between', flexWrap: 'wrap', gap: 18 }, pageCopy: { flex: 1, minWidth: 280, gap: 7 }, eyebrow: { color: colors.brand, fontFamily: typography.bodyStrong, fontSize: 12, letterSpacing: 1.6 }, title: { color: colors.text, fontFamily: typography.display, fontSize: 30, letterSpacing: -1 }, subtitle: { color: colors.textSecondary, fontFamily: typography.body, fontSize: 14, lineHeight: 21 }, filters: { gap: 14 }, chips: { flexDirection: 'row', flexWrap: 'wrap', gap: 8 }, result: { color: colors.textSecondary, fontFamily: typography.bodyStrong, fontSize: 12 }, event: { gap: 8 }, eventHeader: { flexDirection: 'row', justifyContent: 'space-between', gap: 12 }, rowCopy: { flex: 1, gap: 4 }, eventTitle: { color: colors.text, fontFamily: typography.display, fontSize: 17 }, eventAction: { color: colors.brand, fontFamily: typography.bodyStrong, fontSize: 12 }, meta: { color: colors.textSecondary, fontFamily: typography.body, fontSize: 12 }, reason: { color: colors.textSecondary, fontFamily: typography.body, fontSize: 12, lineHeight: 17 }, technical: { color: colors.textMuted, fontFamily: typography.body, fontSize: 12 }, date: { color: colors.textMuted, fontFamily: typography.body, fontSize: 12 }, loader: { paddingVertical: 50 }, empty: { alignItems: 'center', gap: 8, paddingVertical: 42 }, emptyTitle: { color: colors.text, fontFamily: typography.display, fontSize: 17 }, emptyText: { color: colors.textSecondary, fontFamily: typography.body, fontSize: 13 } });
