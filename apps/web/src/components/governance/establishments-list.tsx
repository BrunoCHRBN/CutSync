...
const styles = StyleSheet.create({
  ...
  slug: { color: colors.brand, fontFamily: typography.bodyStrong, fontSize: 12 },
  meta: { color: colors.textSecondary, fontFamily: typography.body, fontSize: 12, lineHeight: 16 },
  badge: { borderRadius: radii.pill, paddingHorizontal: 8, paddingVertical: 4 },
  success: { backgroundColor: colors.successSoft },
  warning: { backgroundColor: colors.warningSoft },
  danger: { backgroundColor: colors.dangerSoft },
  badgeText: { color: colors.textSecondary, fontFamily: typography.bodyStrong, fontSize: 12, textTransform: 'uppercase' },
