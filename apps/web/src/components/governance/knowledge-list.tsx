...
const styles = StyleSheet.create({
  ...
  eyebrow: { color: colors.brand, fontFamily: typography.bodyStrong, fontSize: 12, letterSpacing: 1.6 },
  ...
  filters: { gap: 16 },
  filterRow: { gap: 8 },
  filterLabel: { color: colors.textSecondary, fontFamily: typography.bodyStrong, fontSize: 12, textTransform: 'uppercase', letterSpacing: 0.8 },
  ...
  smallBadgeText: { color: colors.textSecondary, fontFamily: typography.bodyStrong, fontSize: 12, textTransform: 'uppercase' },
  ...
  tag: { color: colors.info, fontFamily: typography.bodyStrong, fontSize: 12 },
  ...
  topicMeta: { color: colors.textMuted, fontFamily: typography.body, fontSize: 12, lineHeight: 16 },
