...
const styles = StyleSheet.create({
  ...
  roleText: { color: colors.ink, fontFamily: typography.bodyStrong, fontSize: 12, textTransform: 'uppercase' },
  ...
  identityEmail: { color: colors.textSecondary, fontFamily: typography.body, fontSize: 12 },
