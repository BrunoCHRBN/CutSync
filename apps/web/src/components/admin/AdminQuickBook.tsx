...
const styles = StyleSheet.create({
  ...
  eyebrow: { color: colors.textSecondary, fontFamily: typography.bodyStrong, fontSize: 12, letterSpacing: 1.5 },
  ...
  quickClientText: { color: colors.brandPrimary, fontFamily: typography.bodyStrong, fontSize: 12 },
  label: { color: colors.textSecondary, fontFamily: typography.bodyStrong, fontSize: 12, marginTop: 4 },
  ...
  dateWeek: { color: colors.textMuted, fontFamily: typography.bodyStrong, fontSize: 12 },
  ...
  timeText: { color: colors.textSecondary, fontFamily: typography.bodyStrong, fontSize: 12 },
  endTimeBanner: {
    flexDirection: 'row',
    alignItems: 'center',
    gap: 8,
