...
const styles = StyleSheet.create({
  ...
  meta: { color: colors.textSecondary, fontFamily: typography.body, fontSize: 12, marginTop: 4, textAlign: 'right' },
  professional: { color: colors.info, fontFamily: typography.bodyStrong, fontSize: 12, marginTop: 5, textAlign: 'right' },
  ...
  stateText: { color: colors.textMuted, fontFamily: typography.body, fontSize: 12, lineHeight: 15 },
  errorState: { backgroundColor: colors.dangerSoft },
  errorTitle: { color: colors.danger, fontFamily: typography.bodyStrong, fontSize: 12 },
  errorText: { color: colors.danger, fontFamily: typography.body, fontSize: 12, marginTop: 3 },
