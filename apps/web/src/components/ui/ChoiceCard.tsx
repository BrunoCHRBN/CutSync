...
const styles = StyleSheet.create({
  ...
  subtitle: { color: colors.textMuted, fontFamily: typography.body, fontSize: 12, lineHeight: 15, marginTop: 3 },
  meta: { color: colors.textSecondary, fontFamily: typography.bodyStrong, fontSize: 12 },
