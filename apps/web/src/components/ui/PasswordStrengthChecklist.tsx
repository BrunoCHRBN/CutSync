...
import { PASSWORD_RULES } from '@cutsync/validation';
...
const styles = StyleSheet.create({
  ...
  title: { color: colors.textSecondary, fontFamily: typography.bodyStrong, fontSize: 12, textTransform: 'uppercase', letterSpacing: 1.2 },
