...
const styles = StyleSheet.create({
  ...
  heatmapDay: { width: 40, color: colors.textSecondary, fontFamily: typography.bodyStrong, fontSize: 12 },
  heatmapHour: { width: 46, textAlign: 'center', color: colors.textMuted, fontFamily: typography.body, fontSize: 12 },
  heatmapCell: { width: 46, height: 38, alignItems: 'center', justifyContent: 'center', borderRadius: radii.sm },
  heatmapCount: { color: colors.textSecondary, fontFamily: typography.bodyStrong, fontSize: 12, fontVariant: ['tabular-nums'] },
