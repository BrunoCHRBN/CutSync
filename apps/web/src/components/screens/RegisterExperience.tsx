...
const styles = StyleSheet.create({
  ...
  eyebrow: { color: colors.brand, fontFamily: typography.bodyStrong, fontSize: 12, letterSpacing: 2 },
  ...
  benefitCopy: { flex: 1 },
  benefitTitle: { color: colors.text, fontFamily: typography.bodyStrong, fontSize: 12 },
  benefitText: { color: colors.textMuted, fontFamily: typography.body, fontSize: 12, lineHeight: 15, marginTop: 3 },
  ...
  formSubtitle: { color: colors.textMuted, fontFamily: typography.body, fontSize: 12, marginTop: -14 },
  ...
  loginText: { color: colors.textMuted, fontFamily: typography.body, fontSize: 12 },
