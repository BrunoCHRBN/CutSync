...
const styles = StyleSheet.create({
  ...
  inviteNote: { color: colors.textMuted, fontFamily: typography.body, fontSize: 12, lineHeight: 16, textAlign: 'center', paddingHorizontal: 18 },
  securityNote: { flexDirection: 'row', alignItems: 'center', gap: 8, marginTop: 20, justifyContent: 'center' },
  securityText: { color: colors.textMuted, fontFamily: typography.body, fontSize: 12 },
  ...
  heroToplineText: { color: colors.white, fontFamily: typography.bodyStrong, fontSize: 12, letterSpacing: 1.4 },
