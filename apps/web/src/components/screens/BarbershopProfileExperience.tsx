...
const styles = StyleSheet.create({
  ...
  heroContainer: { width: '100%', aspectRatio: 2.4, minHeight: 220, maxHeight: 360, position: 'relative', overflow: 'hidden' },
  bannerImage: { width: '100%', height: '100%' },
  bannerFade: { position: 'absolute', left: 0, right: 0, bottom: 0, height: 72 },
  heroCopy: { paddingHorizontal: 24, marginTop: -28, zIndex: 2 },
  ...
  cardsGrid: { borderColor: colors.borderSubtle, borderWidth: 1, overflow: 'hidden' },
  serviceCard: { alignItems: 'center', backgroundColor: colors.surface, borderBottomColor: colors.borderSubtle, borderBottomWidth: hairlineW, flexDirection: 'row', gap: 14, minHeight: 72, paddingHorizontal: 18, paddingVertical: 14 },
  ...
  serviceName: { color: colors.text, flex: 1, fontFamily: typography.bodyStrong, fontSize: 15 },
  servicePrice: { color: colors.brandPrimary, fontFamily: typography.displaySemiBold, fontSize: 16 },
  serviceDuration: { color: colors.labelSoft, fontFamily: typography.mono, fontSize: 11, textTransform: 'uppercase', letterSpacing: 0.8 },
