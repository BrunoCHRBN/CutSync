...
const styles = StyleSheet.create({
  ...
  serviceDuration: { color: colors.labelSoft, fontFamily: typography.body, fontSize: 12 },
  ...
  professionalRole: { color: colors.labelSoft, fontFamily: typography.bodyStrong, fontSize: 12, textTransform: 'uppercase', letterSpacing: 1.2 },
  ...
  floatingEyebrow: { color: colors.labelSoft, fontFamily: typography.bodyStrong, fontSize: 12, letterSpacing: 1.2, textTransform: 'uppercase' },
