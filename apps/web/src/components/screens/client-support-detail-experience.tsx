...
const styles = StyleSheet.create({
  ...
  label: { color: colors.textMuted, fontFamily: typography.bodyStrong, fontSize: 9, letterSpacing: 1.2 },
  protocol: { color: colors.brandPrimary, fontFamily: typography.display, fontSize: 17, marginTop: 5 },
  meta: { color: colors.textMuted, fontFamily: typography.body, fontSize: 11 },
  messages: { gap: 10 },
  message: {
    maxWidth: 760,
  ...
  messageAuthor: { color: colors.brandPrimary, fontFamily: typography.bodyStrong, fontSize: 10 },
  messageBody: { color: colors.text, fontFamily: typography.body, fontSize: 13, lineHeight: 20, marginTop: 6 },
  messageDate: { color: colors.textMuted, fontFamily: typography.body, fontSize: 9, marginTop: 9 },
  replyCard: { gap: 14 },
