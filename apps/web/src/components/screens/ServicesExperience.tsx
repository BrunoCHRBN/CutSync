...
const styles = StyleSheet.create({
  ...
  savingsText: { color: colors.success, fontFamily: typography.bodyStrong, fontSize: 11 },
  memberLine: { color: colors.textMuted, fontFamily: typography.body, fontSize: 11, marginTop: 4 },
  ...
  comboMembers: { gap: 8 },
  helperLabel: { color: colors.textSecondary, fontFamily: typography.bodyStrong, fontSize: 11, marginTop: 4 },
  helperMuted: { color: colors.textMuted, fontFamily: typography.body, fontSize: 11 },
