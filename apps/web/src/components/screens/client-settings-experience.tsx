...
const styles = StyleSheet.create({
  ...
  protectedText: { color: colors.success, fontFamily: typography.bodyStrong, fontSize: 12 },
  ...
  businessEyebrow: { color: colors.brandPrimary, fontFamily: typography.bodyStrong, fontSize: 12, letterSpacing: 1.2, textTransform: 'uppercase' },
  ...
  readonlyLabel: { color: colors.textSecondary, fontFamily: typography.bodyStrong, fontSize: 12 },
  readonlyValue: { color: colors.text, fontFamily: typography.body, fontSize: 13, marginTop: 3 },
  readonlyBadge: { color: colors.textMuted, fontFamily: typography.bodyStrong, fontSize: 12 },
  ...
  linkDescription: { color: colors.textMuted, fontFamily: typography.body, fontSize: 12, lineHeight: 16, marginTop: 3 },
