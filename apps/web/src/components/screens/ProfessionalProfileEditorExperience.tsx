...
const styles = StyleSheet.create({
  ...
  galleryCopy: { flex: 1 },
  galleryUrl: { color: colors.textMuted, fontFamily: typography.body, fontSize: 12 },
  galleryAlt: { color: colors.text, fontFamily: typography.bodyStrong, fontSize: 12, marginTop: 3 },
  ...
  privacyText: { flex: 1, color: colors.textSecondary, fontFamily: typography.body, fontSize: 12, lineHeight: 16 },
  ...
  pixTypeLabel: { fontSize: 12, color: colors.textSecondary, fontFamily: typography.body },
  ...
  previewBadgeText: { color: colors.textMuted, fontFamily: typography.body, fontSize: 12, marginTop: 4 },
});
