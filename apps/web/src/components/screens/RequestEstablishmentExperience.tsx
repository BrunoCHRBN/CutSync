...
const styles = StyleSheet.create({
  ...
  cardEyebrow: { color: colors.brand, fontFamily: typography.bodyStrong, fontSize: 12, letterSpacing: 1.8 },
  ...
  lgpdText: { flex: 1, color: colors.textSecondary, fontFamily: typography.body, fontSize: 12, lineHeight: 16 },
  ...
  indicatorLabel: { fontSize: 12, color: colors.textSecondary, fontFamily: typography.body },
