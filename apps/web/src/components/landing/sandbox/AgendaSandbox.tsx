...
const styles = StyleSheet.create({
  ...
  statusText: { color: colors.success, fontFamily: typography.bodySemiBold, fontSize: 12 },
  ...
  statusButtonText: { color: colors.brand, fontFamily: typography.bodySemiBold, fontSize: 12 },
});
