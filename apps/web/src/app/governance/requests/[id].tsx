...
const styles = StyleSheet.create({ page: { width: '100%', maxWidth: layout.contentMax, alignSelf: 'center', padding: 24, gap: 16, paddingBottom: 80 }, loader: { margin: 50 }, eyebrow: { color: colors.brand, fontFamily: typography.bodyStrong, fontSize: 12, letterSpacing: 2 }, title: { color: colors.text, fontFamily: typography.display, fontSize: 32 }, card: { padding: 22, gap: 8, maxWidth: 680 }, label: { color: colors.textMuted, fontFamily: typography.bodyStrong, fontSize: 12, textTransform: 'uppercase', marginTop: 8 }, value: { color: colors.text, fontFamily: typography.body, fontSize: 15 } });
