...
const styles = StyleSheet.create({
  ...
  backButton: { width: 44, height: 44, alignItems: 'center', justifyContent: 'center', backgroundColor: colors.surface, borderWidth: hairlineW, borderColor: colors.hairline, borderRadius: radii.md },
  ...
  topbarStatusText: { fontFamily: typography.bodyStrong, fontSize: 11, textTransform: 'uppercase', letterSpacing: 1.2 },
  scroll: { width: '100%', maxWidth: layout.contentMax, alignSelf: 'center', paddingBottom: 150 },
  heroContainer: { width: '100%', height: 280, position: 'relative', overflow: 'hidden' },
  bannerImage: { width: '100%', height: '100%' },
  bannerFallback: { width: '100%', height: '100%', alignItems: 'center', justifyContent: 'center', backgroundColor: colors.brandSoft },
  bannerFade: { position: 'absolute', left: 0, right: 0, bottom: 0, height: 140 },
  heroCopy: { paddingHorizontal: 24, marginTop: -48, zIndex: 2 },
  heroCopyWide: { paddingHorizontal: 40 },
  brandContainer: { flexDirection: 'row', gap: 18, flexWrap: 'wrap', alignItems: 'flex-end' },
  logoCircle: { width: 96, height: 96, borderRadius: 48, borderWidth: 3, borderColor: colors.surface, backgroundColor: '#FAFAF8', alignItems: 'center', justifyContent: 'center', overflow: 'hidden', ...atmosphericShadow },
  logoImage: { width: '100%', height: '100%' },
  logoLetter: { fontFamily: typography.serif, fontSize: 32, color: '#52525B', letterSpacing: 1 },
  titleInfo: { flex: 1, minWidth: 260, justifyContent: 'flex-end' },
  titleRow: { flexDirection: 'row', alignItems: 'center', flexWrap: 'wrap', gap: 10 },
  title: { color: colors.text, fontFamily: typography.displaySemiBold, fontSize: 34, letterSpacing: -1.2 },
  slogan: { color: colors.textSecondary, fontFamily: typography.serif, fontSize: 14, marginTop: 6, fontStyle: 'italic' },
  instagramBadge: { flexDirection: 'row', alignItems: 'center', gap: 5, backgroundColor: colors.surface, borderRadius: radii.md, paddingHorizontal: 10, paddingVertical: 6, borderWidth: hairlineW, borderColor: colors.border },
  instagramBadgeText: { fontSize: 11, fontFamily: typography.bodyStrong, color: colors.textSecondary },
  description: { color: colors.textSecondary, fontFamily: typography.body, fontSize: 15, lineHeight: 24, marginTop: 10 },
  infoGrid: { flexDirection: 'row', flexWrap: 'wrap', marginHorizontal: 24, marginTop: 28, borderWidth: 1, borderColor: colors.borderSubtle, backgroundColor: colors.surface },
  infoItem: { flex: 1, minWidth: 200, flexDirection: 'row', gap: 12, padding: 18, borderRightWidth: 1, borderRightColor: colors.borderSubtle },
  infoIcon: { width: 34, height: 34, alignItems: 'center', justifyContent: 'center', backgroundColor: colors.canvas, borderRadius: radii.md },
  infoCopyText: { flex: 1 },
  infoLabel: { color: colors.labelSoft, fontFamily: typography.bodyStrong, fontSize: 11, textTransform: 'uppercase', letterSpacing: 1.6 },
  infoValue: { color: colors.text, fontFamily: typography.body, fontSize: 12, marginTop: 4 },
  ...
  mapCard: { marginHorizontal: 24, marginTop: 28, borderRadius: radii.lg, borderWidth: hairlineW, borderColor: colors.hairline, overflow: 'hidden', backgroundColor: colors.surface, ...atmosphericShadow },
  mapThumbnail: { width: '100%', height: '100%' },
  mapInfoBar: { flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', padding: 14, backgroundColor: colors.surface, borderTopWidth: hairlineW, borderTopColor: colors.hairline },
  mapInfoAddress: { color: colors.textSecondary, fontFamily: typography.body, fontSize: 12 },
  routeBtn: { minHeight: 36, paddingVertical: 6, paddingHorizontal: 12 },
  section: { marginTop: 48, paddingHorizontal: 24, gap: 18 },
  ...
  cardIcon: { width: 34, height: 34, alignItems: 'center', justifyContent: 'center', borderRadius: radii.md, backgroundColor: colors.canvas, borderWidth: hairlineW, borderColor: colors.hairline },
  serviceName: { color: colors.text, fontFamily: typography.bodyStrong, fontSize: 14, marginTop: 16 },
  servicePrice: { color: colors.brandPrimary, fontFamily: typography.displaySemiBold, fontSize: 18, letterSpacing: -0.4, marginTop: 8 },
  serviceDuration: { color: colors.labelSoft, fontFamily: typography.mono, fontSize: 11, textTransform: 'uppercase', letterSpacing: 1, marginTop: 5 },
  ...
  barberInstaBtn: { flexDirection: 'row', alignItems: 'center', gap: 4, marginTop: 10, paddingVertical: 4, paddingHorizontal: 9, borderRadius: radii.md, backgroundColor: colors.canvas, borderWidth: hairlineW, borderColor: colors.hairline },
  ...
  floatingBar: {
    ...
    ...glassSurface,
    ...Platform.select({
      web: { boxShadow: '0 18px 48px rgba(24,32,27,0.12)' } as any,
  ...
  floatingEyebrow: { color: colors.labelSoft, fontFamily: typography.bodyStrong, fontSize: 11, letterSpacing: 1.4, textTransform: 'uppercase' },
  floatingTitle: { color: colors.text, fontFamily: typography.displaySemiBold, fontSize: 15, letterSpacing: -0.3, marginTop: 3 },
  floatingButton: { flexDirection: 'row', alignItems: 'center', gap: 7, minHeight: 46, paddingHorizontal: 18, borderRadius: radii.md },
  floatingButtonText: { fontFamily: typography.bodyStrong, fontSize: 13 },
  ...
  bottomSheetTitle: { fontFamily: typography.displaySemiBold, fontSize: 18, color: '#1A1A1E' },
  ...
  profName: { fontSize: 22, fontFamily: typography.displaySemiBold, color: '#1A1A1E', marginTop: 4 },
  profRoleTitle: { fontSize: 12, fontFamily: typography.body, color: colors.textMuted },
  profRatingRow: { flexDirection: 'row', alignItems: 'center', gap: 5, backgroundColor: '#F8F9FA', paddingHorizontal: 10, paddingVertical: 4, borderRadius: radii.md, borderWidth: 1, borderColor: '#E4E5DF', marginTop: 4 },
  ...
  profChip: { backgroundColor: '#F0ECE0', paddingHorizontal: 10, paddingVertical: 5, borderRadius: radii.md },
  ...
  profServicePrice: { fontSize: 14, fontFamily: typography.displaySemiBold, color: '#113939' },
