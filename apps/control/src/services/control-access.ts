...
const errorMessages: Record<string, string> = {
  ...
  access_expiry_required: 'Este perfil exige uma data de expiração.',
  access_profile_not_found: 'O perfil solicitado não está mais disponível.',
  access_reason_required: 'Informe uma justificativa entre 10 e 500 caracteres.',
  access_request_not_approved: 'A solicitação ainda não está aprovada para aplicação.',
  access_request_not_found: 'A solicitação não foi encontrada.',
  access_request_not_pending: 'A solicitação já foi decidida. Atualize a fila.',
  access_ticket_required: 'Informe uma referência válida para o chamado interno.',
  ...
  idempotency_conflict: 'A operação foi repetida com dados diferentes. Atualize a tela e tente novamente.',
  invalid_access_decision: 'Revise a decisão e a justificativa informadas.',
  invalid_access_request_status: 'O filtro de solicitações é inválido.',
  approval_separation_required: 'Solicitante e beneficiário não podem aprovar esta solicitação.',
  approval_version_conflict: 'A solicitação mudou desde a última leitura. Atualize a fila.',
  control_assignment_already_active: 'Este perfil já está ativo para a pessoa informada.',
  control_assignment_not_active: 'Não existe uma atribuição ativa desse perfil para revogar.',
