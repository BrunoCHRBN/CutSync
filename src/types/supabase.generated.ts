...
export type Database = {
  public: {
    Tables: {
      appointments: {
        Row: { cancellation_reason: string | null; cancelled_by_role: string | null; client_id: string | null; client_name: string | null; created_at: string; date_time: string; deleted_at: string | null; duration_minutes: number; ends_at: string; establishment_id: string; id: string; original_date_time: string | null; professional_id: string; reschedule_count: number; service_id: string; status: string; updated_at: string };
      ...
      profiles: {
        Row: { avatar_url: string | null; commission_rate: number; created_at: string; deleted_at: string | null; email: string; establishment_id: string | null; id: string; instagram: string | null; name: string; phone: string | null; push_token: string | null; role: string; specialties: string | null; titulo_profissional: string | null; updated_at: string; work_hours: string | null; lgpd_terms_accepted: boolean; lgpd_marketing_accepted: boolean; lgpd_accepted_at: string | null; pix_key: string | null; notification_channels: string[] | null };
