...
const styles = StyleSheet.create({
  ...
  description: { color: colors.textMuted, fontFamily: typography.body, fontSize: 10, marginTop: 3 },
  ...
  meta: { color: colors.textSecondary, fontFamily: typography.body, fontSize: 10, marginTop: 4, textAlign: 'right' },
  professional: { color: colors.info, fontFamily: typography.bodyStrong, fontSize: 9, marginTop: 5, textAlign: 'right' },
  ...
  stateText: { color: colors.textMuted, fontFamily: typography.body, fontSize: 10, lineHeight: 15 },
  errorState: { backgroundColor: colors.dangerSoft },
  errorTitle: { color: colors.danger, fontFamily: typography.bodyStrong, fontSize: 12 },
  errorText: { color: colors.danger, fontFamily: typography.body, fontSize: 10, marginTop: 3 },
