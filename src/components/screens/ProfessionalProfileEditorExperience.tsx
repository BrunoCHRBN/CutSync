...
const styles = StyleSheet.create({
  ...
  galleryList: { gap: 8 }, galleryRow: { flexDirection: 'row', alignItems: 'center', gap: 10, padding: 12, borderRadius: radii.md, backgroundColor: colors.canvasSoft, borderWidth: 1, borderColor: colors.border }, galleryCopy: { flex: 1 }, galleryUrl: { color: colors.textMuted, fontFamily: typography.body, fontSize: 9 }, galleryAlt: { color: colors.text, fontFamily: typography.bodyStrong, fontSize: 11, marginTop: 3 }, removeButton: { width: 40, height: 40, alignItems: 'center', justifyContent: 'center', borderRadius: radii.md, backgroundColor: colors.dangerSoft },
