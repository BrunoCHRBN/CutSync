...
import { ArrowLeft, ExternalLink, Link2, ShieldCheck, Sparkles } from 'lucide-react-native';
        ...
        <View style={[styles.hero, isWide && styles.heroWide]}>
          ...
          <View style={styles.heroCopy}>
            ...
            <View style={styles.links}>
              ...
              {!!profile.instagramUrl && <AppButton testID="public-professional-profile-instagram-button" label="Ver Instagram" onPress={() => Linking.openURL(profile.instagramUrl!)} variant="secondary" icon={<Link2 color={colors.text} size={16} />} />}
            </View>
          </View>
        </View>
...
const styles = StyleSheet.create({
  ...
  topbarTitle: { flex: 1, color: colors.text, fontFamily: typography.bodyStrong, fontSize: 12 }, privacyBadge: { flexDirection: 'row', alignItems: 'center', gap: 6, paddingHorizontal: 10, paddingVertical: 7, borderRadius: radii.pill, backgroundColor: colors.successSoft }, privacyBadgeText: { color: colors.success, fontFamily: typography.bodyStrong, fontSize: 11 },
  ...
  heroCopy: { flex: 1, maxWidth: 620 }, eyebrow: { color: colors.brand, fontFamily: typography.bodyStrong, fontSize: 11, letterSpacing: 2.2 }, name: { color: colors.text, fontFamily: typography.display, fontSize: 46, lineHeight: 50, letterSpacing: -2, marginTop: 14 }, title: { color: colors.textSecondary, fontFamily: typography.serif, fontSize: 21, marginTop: 10 }, specialties: { color: colors.text, fontFamily: typography.bodyStrong, fontSize: 13, lineHeight: 20, marginTop: 24 }, bio: { color: colors.textSecondary, fontFamily: typography.body, fontSize: 15, lineHeight: 25, marginTop: 20 }, links: { flexDirection: 'row', flexWrap: 'wrap', gap: 10, marginTop: 28 },
  gallerySection: { gap: 24 }, galleryHeading: { flexDirection: 'row', alignItems: 'flex-start', gap: 12 }, galleryEyebrow: { color: colors.textMuted, fontFamily: typography.bodyStrong, fontSize: 11, letterSpacing: 1.8 }, galleryTitle: { color: colors.text, fontFamily: typography.display, fontSize: 28, letterSpacing: -1, marginTop: 5 }, galleryGrid: { flexDirection: 'row', flexWrap: 'wrap', gap: 16 }, galleryItem: { width: '48%', minWidth: 260, flexGrow: 1, aspectRatio: 1, borderRadius: radii.lg, overflow: 'hidden', backgroundColor: colors.surfaceRaised, ...atmosphericShadow }, galleryItemFeatured: { aspectRatio: 1.2 }, galleryImage: { width: '100%', height: '100%' }, galleryCaption: { position: 'absolute', left: 0, right: 0, bottom: 0, padding: 16, backgroundColor: 'rgba(10,10,10,0.72)' }, galleryCaptionText: { color: colors.white, fontFamily: typography.bodyStrong, fontSize: 11, lineHeight: 16 },
