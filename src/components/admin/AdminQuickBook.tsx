...
const styles = StyleSheet.create({
  ...
  eyebrow: { color: colors.textSecondary, fontFamily: typography.bodyStrong, fontSize: 8, letterSpacing: 1.5 },
  ...
  dateWeek: { color: colors.textMuted, fontFamily: typography.bodyStrong, fontSize: 9 },
