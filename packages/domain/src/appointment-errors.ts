...
const appointmentErrorMessages: Record<string, string> = {
  ...
  appointment_reassignment_requires_workflow: 'A troca de profissional exige a decisão do cliente e ficará disponível na Central de Decisões.',
  appointment_locked_by_service_order: 'Este atendimento já possui uma comanda e não pode trocar de profissional por este fluxo.',
  transfer_reason_required: 'Escolha um motivo operacional válido para a correção.',
