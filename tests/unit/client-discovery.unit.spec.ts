...
test('adensa o Client web explore→detalhe→booking no padrão marketplace', () => {
  ...
  const bookingExport = readSource('apps/web/src/components/screens/BookingExperience.tsx');
  ...
  expect(bookingExport).toContain('EstablishmentBookingExperience as BookingExperience');
